...
function Footer() {
  return (
    <footer className="flex w-screen flex-col items-center bg-gray-100 lg:h-130">
      ...
      <div className="flex h-42 w-[60%] items-start justify-around">
